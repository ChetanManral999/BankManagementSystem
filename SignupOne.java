...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        others.setBounds(630, 290, 70, 30);
        add(others);
        ...
        pinTextField.setFont(new Font("raelway", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String formno = "" + random;// to convert long random to string
        String name = nameTextField.getText();
        String fname = fnameTextField.getText();
        String dob = ((JTextField) dateChooser.getDateEditor().getUiComponent()).getText();//getui returns a textField
        String gender=null;
        if(male.isSelected()){
            gender="Male";
        }
        ...
        String pin=stateTextField.getText();
        try{
            if(name.equals("")){
